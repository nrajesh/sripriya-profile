...
export const socialLinks = [
  {
    href: "https://www.facebook.com/ashwinsanghi",
    label: "Facebook",
    icon: Facebook,
  },
  {
    href: "https://twitter.com/ashwinsanghi",
    label: "Twitter",
    icon: Twitter,
  },
  {
    href: "https://www.instagram.com/ashwinsanghi",
    label: "Instagram",
    icon: Instagram,
  },
  {
    href: "https://www.youtube.com/user/ashwinsanghi",
    label: "YouTube",
    icon: Youtube,
  },
];
